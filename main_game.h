...
extern int k;
extern int cx, cy;
extern int map[6][200][200];
extern int revealed[6][200][200];
...
extern int error;
extern int done,clashed;
extern int picked_gun;
extern int diff,button;
extern int akey,bkey;
extern int potion_stack[3];
extern int gun_stack[5];
extern int potions,allcoin,enemy_health[6][200][200];
extern int themed[6][200][200],movable[6][200][200];
...
void draw_rectangle(int l, int w, int map[6][200][200], int index);
